...
class ProcessAction {
	...
	class goldrefined {
        ...
        //ScrollText = "Processing Goldnugget";
        NoLicenseCost = 2000;
    };
	
	class whiskey {
        MaterialsReq[] = {{"barley",1}};
	...
	class rice {
        MaterialsReq[] = {{"ear_of_rice",1}};
        MaterialsGive[] = {{"rice",1}};
        Text = "STR_Process_rice";
        //ScrollText = " Process rice";
        NoLicenseCost = 10000;
    };
};
