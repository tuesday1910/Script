...
if !(playerSide isEqualTo west || playerSide isEqualTo east) exitWith {}; // Only for cops open this menu
...
{
    private _side = switch (side _x) do {case west: {"Cop"}; case civilian : {"Civ"}; case east:{"Adac"}; case independent:{"Medic"}; default {"Unknown"};};
