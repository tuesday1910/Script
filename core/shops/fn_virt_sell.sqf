...
if (LIFE_SETTINGS(getNumber,"player_moneyLog") isEqualTo 1) then {
    if (LIFE_SETTINGS(getNumber,"battlEye_friendlyLogging") isEqualTo 1) then {
        ...
        money_log = format [localize "STR_DL_ML_sellitem",profileName,(getPlayerUID player),(localize _name),_price,[BANK] call life_fnc_numberText,[CASH] call life_fnc_numberText];
    };
