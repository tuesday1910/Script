...
class MAV_guiWeaponShop {
	...
	onLoad = "['weaponshop\gui', 'MAV_guiWeaponShop', _this, true] call MAV_gui_fnc_openGUI";
	class Controls {
...
class MAV_guiWeaponShopSimple {
	...
	onLoad = "['weaponshop\gui', 'MAV_guiWeaponShopSimple', _this, true] call MAV_gui_fnc_openGUI";
	class Controls {
