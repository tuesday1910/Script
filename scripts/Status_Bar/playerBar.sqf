...
waitUntil{isNull (findDisplay 38500)};
	...
	while {true} do 
	{
		...
		_time = (round(360-(serverTime)/60));  //edit the '360' value (60*6=360) to change the countdown timer if your server restarts are shorter or longer than 6 hour intervals
		...
		((uiNamespace getVariable "statusBar")displayCtrl 55555)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='scripts\status_bar\images\ts3.paa' color='%10'/>oxygenlife.ts3th.me</t>
